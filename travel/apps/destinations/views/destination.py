...
class BaseDestinationView(NoCommunityRequiredMixin, BaseInlineModelFormMixin):
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            destination.has_wifi=request.POST.get('id_has_wifi')
            destination.has_breakfast_incluided=request.POST.get('id_has_breakfast_incluided')
            destination.has_gym=request.POST.get('id_has_gym')
            destination.has_air_conditioning=request.POST.get('id_has_air_conditioning')
            destination.has_restaurant=request.POST.get('id_has_restaurant')
            destination.has_bar=request.POST.get('id_has_bar')
            destination.has_housekeeping=request.POST.get('id_has_housekeeping')
            destination.has_room_service=request.POST.get('id_has_room_service')
            destination.has_business_services=request.POST.get('id_has_business_services')
            destination.has_hob_tub=request.POST.get('id_has_hob_tub')
            destination.has_front_desk=request.POST.get('id_has_front_desk')
            destination.has_laundry=request.POST.get('id_has_laundry')
            destination.save()
